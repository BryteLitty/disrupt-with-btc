...
function GetStarted() {
    return (
      <div className='mx-5 pt-20 mb-10 flex flex-col justify-center'>
        <DefaultText 
          className="font-bold text-4xl mb-5 dark:bg-custom-gradient dark:text-transparent dark:bg-clip-text" 
          title='Get Started Today' 
        />
  
        <p className='font-pop text-darkGrayHue mx-5 md:mx-32 md:inline-block justify-center lg:mx-60 dark:text-light'>
          Join the movement. Start accepting fast, borderless Bitcoin payments with zero setup fees. 
          Built for creators, powered by Lightning. No banks. No barriers.
        </p>
